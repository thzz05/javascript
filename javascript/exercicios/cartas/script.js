...
function sortearCarta(){
    ...
    //aplicar cor
    document.getElementById('supEsq').style.color = cor // adiconar cor css
    document.getElementById('centro').style.color = cor // adiconar cor css
    document.getElementById('infDir').style.color = cor // adiconar cor css
